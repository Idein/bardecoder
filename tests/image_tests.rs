...
pub fn test_crash() {
    ...
    test_image("tests/images/crash1.jpg");
    test_image("tests/images/crash2.jpg");
    test_image("tests/images/crash3.jpg");
}
...
pub fn test_version1_example() {
    test_image(
        ...
        vec![Ok(String::from("01234567").into_bytes())],
    );
}
...
pub fn test_version1_example_with_info() {
    test_image_with_info(
        "tests/images/version1_example.jpg",
        vec![Ok((
            String::from("01234567").into_bytes(),
            QRInfo {
                version: 1,
...
pub fn test_version1_example_no_border() {
    test_image(
        ...
        vec![Ok(String::from("Ver1").into_bytes())],
    );
}
...
pub fn test_version1_example2() {
    test_image(
        ...
        vec![Ok(String::from("0P1UF3L3016456").into_bytes())],
    );
}
...
pub fn test_version3_example2() {
    test_image(
        ...
        vec![Ok(
            String::from("http://www.prolinepetfood.com/1/").into_bytes()
        )],
    );
}
...
pub fn test_needs_alignment() {
    test_image(
        ...
        vec![Ok(
            String::from("http://cblink.je/app-install-display-nl").into_bytes()
        )],
    );
}
...
pub fn test_multiple_codes() {
    test_image(
        ...
        vec![
            Ok(String::from("http://www.prolinepetfood.com/1/").into_bytes()),
            Ok(String::from("Ver1").into_bytes()),
        ],
    );
}
...
pub fn test_wikipedia_examples() {
    ...
    test_image(
        ...
        vec![Ok(String::from("Version 2").into_bytes())],
    );

    test_image(
        "tests/images/wikipedia/version3_example.png",
        vec![Ok(String::from("Version 3 QR Code").into_bytes())],
    );

    test_image(
        "tests/images/wikipedia/version4_example.png",
        vec![Ok(
            String::from("Version 4 QR Code, up to 50 char").into_bytes()
        )],
    );
    ...
    test_image(
        ...
        vec![Ok(version_25_40_text.clone().into_bytes())],
    );

    test_image(
        "tests/images/wikipedia/version40_example.png",
        vec![Ok(version_25_40_text.into_bytes())],
    );
}

pub fn test_image(file: &str, expected: Vec<Result<Vec<u8>, Error>>) {
    let img = image::open(file).unwrap();
...
pub fn test_image_with_info(file: &str, expected: Vec<Result<(Vec<u8>, QRInfo), Error>>) {
    let img = image::open(file).unwrap();
